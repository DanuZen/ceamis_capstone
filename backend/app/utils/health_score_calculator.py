...
def get_spending_category(health_score: float) -> str:
    """Kategorisasi gaya belanja berdasarkan health score (threshold deterministik).
    
    Menggantikan model ML clustering terpisah.
    Threshold berdasarkan riset FinHealth Score:
      - Score >= 80: "Sehat"
      - Score >= 40: "Waspada"
      - Score < 40:  "Boros"
    """
...
def calculate_health_score(
    ...
    # ── Spending Category (threshold deterministik) ─────
    category = get_spending_category(health_score)
